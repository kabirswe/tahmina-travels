<div class="sidebar" id="sidebar">
    ...
    @role('vendor')
    @if(Auth::user()->can('product-create') || Auth::user()->can('localvendor-product-list'))
    {{-- Operator Products Management nav block --}}
    <div class="d-flex flex-column account-block">
        <h2 class="title">
            <img class="icon-support" src="{{ asset('image/icon-product.svg') }}" alt="island icon">
        ...
        @can('localvendor-product-list')
        <a class="menu-link{{ Route::is('localvendorProductList') ? ' active' : '' }}" href="{{ route('localvendorProductList') }}">
            <span>商品一覧</span>
            <span class="rito rito-chevron-right"></span>
        </a>
        @endcan
        @can('localvendor-product-create')
        <a class="menu-link{{ Route::is('localvendor.product.create') ? ' active' : '' }}" href="{{ route('localvendor.product.create') }}">
            <span>商品登録</span>
            <span class="rito rito-chevron-right"></span>
        </a>
        @endcan
